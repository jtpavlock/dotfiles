(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (systemd evil-surround evil-nerd-commenter org-bullets evil-tutor evil flx smex counsel ivy general which-key linum-relative zenburn-theme smart-mode-line use-package))))
(custom-set-faces
